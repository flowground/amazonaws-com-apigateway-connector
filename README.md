# ![LOGO](logo.png) Amazon API Gateway **flow**ground Connector
...
#### Input Parameters
* `restapi_id` - _required_
* `requestvalidator_id` - _required_
* `X-Amz-Content-Sha256` - _optional_
* `X-Amz-Date` - _optional_
* `X-Amz-Algorithm` - _optional_
* `X-Amz-Credential` - _optional_
...
**flow**ground :- Telekom iPaaS / amazonaws-com-apigateway-connector<br/>
